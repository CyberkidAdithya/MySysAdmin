...
"color: rgb(155, 155, 255);")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; color:#9b9bff;\">AstreaA</span> Your Personal A.I.</p></body></html>", None))
        ...
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"by: Shadow Breakerz", None))
    # retranslateUi
