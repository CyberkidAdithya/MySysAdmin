...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title.setText(QCoreApplication.translate("MainWindow", u"AstraeA - The Smart PeaceKeeper", None))
#if QT_CONFIG(tooltip)
        self.btn_close.setToolTip(QCoreApplication.translate("MainWindow", u"Close", None))
#endif // QT_CONFIG(tooltip)
        self.btn_close.setText("")
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"\"Python says 'Beautiful is better than Ugly'.\"", None))
#if QT_CONFIG(tooltip)
