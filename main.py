...
from psutil import cpu_percent, virtual_memory as vm
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        ## ==> DEF START VALUES
        self.ui.sliderCPU.setValue(cpu_percent(1))
        self.ui.sliderGPU.setValue(getGPUs()[0].load)
        self.ui.sliderRAM.setValue(vm().percent)
